...
const NoVisibilityPasswordSVG: FC<ISvgProps> = ({
  width = '24',
  height = '24',
  fill,
}) => (
  ...
  >
    <path
      ...
      strokeWidth='1.5'
    />
    <circle cx='12' cy='12' r='3' stroke={fill} strokeWidth='1.5' />
  </svg>
);
const NoVisibilityPassword = memo(NoVisibilityPasswordSVG);
export default NoVisibilityPassword;
